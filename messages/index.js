...
module.exports = {
  ...
  type: {
    ...
    de: '{{#def.t}}muss {{? t == "number" }}eine Zahl{{?? t == "integer"}}eine ganze Zahl{{?? t == "string"}}ein Text{{?? t == "boolean"}} boolescher Wert{{??}}{{=t}}{{?}} sein',
    ...
    it: '{{#def.t}}deve essere {{? t == "number" }}un numero{{?? t == "integer"}}un numero intero{{?? t == "string"}}un testo{{?? t == "boolean"}} booleano{{??}}{{=t}}{{?}}',
